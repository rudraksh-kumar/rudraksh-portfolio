...
const Experience = () => {
  return (
    <section className="py-24 border-t border-black/5 dark:border-white/5 transition-colors duration-300" id="experience">
      <motion.div
      ...
      >
        <h2 className="text-3xl md:text-5xl font-heading font-bold text-slate-900 dark:text-white mb-12 pb-2 leading-tight">
        ...
        <div className="space-y-6">
          {experiences.map((exp, index) => (
            <motion.div
              ...
              className="p-8 rounded-3xl bg-white/80 dark:bg-surface border border-black/5 dark:border-white/5 hover:border-accent/30 dark:hover:border-accent/30 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm dark:shadow-none"
            >
              <div>
              ...
              <div className="shrink-0">
                <span className="text-sm font-mono text-slate-500 dark:text-gray-500 bg-slate-100 dark:bg-background px-4 py-2 rounded-full border border-black/5 dark:border-white/5">
                  {exp.date}
                </span>
              </div>
            </motion.div>
